...
public class MapsActivity extends FragmentActivity implements
    ...
    String server_url = "http://utile-leaving.000webhostapp.com/latlong.php";
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        //Creating a random coordinate CHANGE IT TO SURAT
        LatLng latLng = new LatLng(21.1702,72.8311);
    ...
    public void onClick(View v) {
        if(v == buttonCurrent){
            ...
            Intent i = new Intent(MapsActivity.this,ViewSavedActivty.class);
            startActivity(i);
        }
    }
